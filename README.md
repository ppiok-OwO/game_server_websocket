...
```
### 게임의 컨셉
=> 배가 고픈 주인공이 동네 PT쌤을 요리조리 피해 떡볶이 재료를 모아서 맛있게 만들어 먹는 게 이 게임의 목표입니다! 만약 잡힌다면 스쿼트를 피할 수 없을 것…이 아니라 가진 재료 중의 하나를 랜덤하게 빼앗깁니다! ㅇ0ㅇ) / oh, no!
...
- 게임 시간(좌측 상단)이 10초 지날 때마다 스테이지가 1씩 증가합니다.
